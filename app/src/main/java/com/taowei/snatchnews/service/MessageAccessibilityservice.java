package com.taowei.snatchnews.service;
...
import com.taowei.snatchnews.activity.MainActivity;
import com.taowei.snatchnews.utils.Util;
    ...
    private void openHongBaoInChatPage(AccessibilityEvent event) {
        ...
        if (nodeInfo != null && "android.widget.TextView".equals(nodeInfo.getClassName())) {//消息内容改变的时候
            ...
            if (rootNodeInfo != null) {
                list = rootNodeInfo.findAccessibilityNodeInfosByText("领取红包");
                checkList(list);
